...
use App\Http\Requests\Dashboard\ExamService\StorePdfExamRequest;
...
class ExamServiceController extends Controller
{
    ...
    public function saveInfoExam(StorePdfExamRequest $request)
    {
        $teacherExam = TeacherExam::create($request->except('mediaQuestion','mediaAnswer'));
